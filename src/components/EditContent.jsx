...
const EditContent = ({
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      item?.type === 'income' ? dispatch(updateIncomeAction(data)) : dispatch(updateExpAction(data));
      item?.type === 'income' ? history.push('/user-income') : history.push('/user-expenses')
    },
          ...
          <div className="col-12 col-md-8 col-lg-5 mx-auto">
            <div className="p-4 shadow-sm rounded bg-white">
              <form onSubmit={formik.handleSubmit}>
                ...
                {item?.type === 'income' ? <h2>Income Updates</h2> : <h2>Expense Update</h2> }
